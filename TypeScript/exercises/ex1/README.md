...
1. Click on *Files & Folders* on the *Welcome* page to open the workspace */home/user/projects*
<br><br>![](images/01_01_0009.png)<br><br>

1. Click on *Start from template* on the *Get Started* page.
    * [Optional] If you have closed the *Get Started* page accidentally, click in the header toolbar on *Help*, and select *Get Started*.</ul>
