...
[![demo](https://flat.badgen.net/badge/demo/deployed/blue?icon=chrome)](https://SAP-samples.github.io/teched2022-AD163/TypeScript/exercises/ex2/sensormanager/webapp/)
...
1. Click on `manifest.json` link in the *Application Info* page. 
2. Go to the section `sap.ui5`.
